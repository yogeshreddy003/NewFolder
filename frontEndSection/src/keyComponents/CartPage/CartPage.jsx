    ...
    <div className="font-sans bg-gray-50">
      ...
      <header className="flex justify-between items-center px-6 py-4 shadow">
        ...
        <nav className="flex gap-6">
          <a onClick={() => navigate("/home")} className="hover:text-red-600">
            Home
          </a>
          <a onClick={() => navigate("/contact")} className="hover:text-red-600">
            Contact
          </a>
          <a onClick={() => navigate("/about")} className="hover:text-red-600">
            About
          </a>
        </nav>
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="md:col-span-2 space-y-4">
            {cart.items.map((item) => (
              <div className="flex bg-white p-4 rounded shadow" key={item.productId._id}>
                <img
