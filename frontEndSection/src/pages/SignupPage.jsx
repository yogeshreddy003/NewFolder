  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(
        "https://newfolder-biza.onrender.com/api/user/signup",
        {
          method: "POST",
        ...
        <div className="flex-1 flex items-center">
          <form className="w-full max-w-sm mx-auto space-y-4">
            ...
            <button
              ...
              className="w-full bg-[#db4444] text-white py-2 rounded font-semibold"
              type="submit"
            >
              Create Account
            </button>
            ...
            <div className="text-center text-gray-500">
              ...
              <button
                type="button"
                onClick={() => navigate("/")}
                className="text-[#db4444] font-medium underline hover:no-underline"
              >
                Log In
              </button>
            </div>
